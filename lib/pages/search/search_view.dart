    ...
    return Scaffold(
      appBar: AppBar(
        title: TextField(
          ...
          decoration: InputDecoration(labelText: tr('main.search')),
          onChanged: (value) {
            setState(() {
                  ...
                  trailing: SizedBox(
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (BuildContext context, AsyncSnapshot snapshot) {
                        final percentageChange = MainModel
                                        .data[_auxStockList[index].ticker]
                                        ?.todayValue !=
                                    null &&
                                MainModel.data[_auxStockList[index].ticker]
                                        ?.yesterdayValue !=
                                    null
                            ? ((MainModel.data[_auxStockList[index].ticker]
                                            ?.todayValue ??
